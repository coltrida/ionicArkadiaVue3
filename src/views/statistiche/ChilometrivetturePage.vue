  ...
  <ion-page>
    ...
    <ion-content>
        <ion-item>
            ...
            <ion-select interface="popover" v-model="elemento.vettura">
                <ion-select-option v-for="ute in vetture" :key="ute.id" :value="ute.id">
                    {{ute.name}}
                </ion-select-option>
            </ion-select>
        </ion-item>
...
IonSelectOption, IonSelect, IonAvatar, IonModal} from '@ionic/vue';
import help from '@/help';

export default defineComponent({
      name: 'ChilometrivetturePage',
    ...
    computed:{
      ...
      methods:{
            visualizza(){
                this.axios.post(`${help().linkstatisticachilometrivettura}`, this.elemento).then((response) => {
